<template>
  <div class="card mt-3">
    <div class="card-header">
      <h3 class="card-title">Cuentas Afiliadas</h3>
    </div>
    <div class="table-responsive pt-4">
      <vue-bootstrap4-table
        :rows="payment.list_bank_user ? payment.list_bank_user : []"
        :columns="columns"
        :config="config"
...
export default {
  ...
  computed: {
      ...mapState({
    payment: state => state.bankUsers.payment,
    loading: state => state.bankUsers.loading
  }),
  },
   watch: {
    'type': function (val) {
