...
<body>
  ...
  <main>
    <table>
      <thead>
        <tr>
        <th class="service">Combinaciones</th>
          <th class="desc">Costo Polla</th>
          <th>Monto en Casa</th>
        </tr>
      </thead>
      <tbody>
          ...
          <tr>
            <td class="service"><strong> <?php echo $combinaciones ?> </strong></td>
            <td class="desc"><strong>  <?php echo number_format($cost, 2) ?> </strong></td>
            <td class="desc"><strong> <?php echo number_format($subtotal, 2) ?>  </strong></td>
          
          </tr>
       
        <tr>
          <td class="below-table" colspan="2" class="grand total">TOTAL GANANCIA</td>
          <td class="grand total"><strong><?php echo number_format($ganancia, 2) ?> </strong></td>
        </tr>
