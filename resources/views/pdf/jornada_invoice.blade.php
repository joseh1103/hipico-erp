...
<body>
  <header class="clearfix">
    ...
    <h1 class="order-title">Reporte por Jornadas</h1>

    <div class="row-ordersale">
    <div id="company" class="clearfix column-order">
      <h3 class="title-type-order">Datos del Reporte</h3>
      <div><b class="label">Fecha: </b> <span class="responsedata"><?php echo $date; ?></span></div>
    </div>
  ...
  <main>
    <table>
      ...
      <?php
        ...
        ?>
          <tr>
            <td class="service"><strong> <?php echo $item['jornada_id'] ?> </strong></td>
            <td class="service"><strong> <?php echo $item['date'] ?> </strong></td>
            <td class="service"><strong> <?php echo number_format($item['monto_casa'], 2) ?> </strong></td>
